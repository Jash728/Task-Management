...
const Main = () => {
  ...
  const filteredTasks = tasks.filter((task) => {
    // Check the sidebar filter criteria
    const sidebarFilterMatch = (() => {
      switch (filter) {
        case "important":
        ...
        case "doItNow":
          ...
          return taskDueDate === today || taskDueDate === tomorrowDate;
        default:
          return true; // No sidebar filter, match all tasks
      }
    })();

    // Check the category and search query filters
    ...
    return sidebarFilterMatch && categoryFilterMatch && searchFilterMatch;
  });
